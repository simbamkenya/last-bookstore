...
function Header() {
    ...
    return (
        <nav className='flex items-center justify-center flex-wrap py-6 bg-[#D6E3EC] px-6 sticky top-0 z-50 lg:justify-between'>
            ...
            <div className='w-full block  lg:flex lg:item-center lg:w-auto lg:flex-end'>
                <div className='text-sm'>
                   <div className='text-center'>
                    <Link to="/shop" className='block mt-4 lg:inline-block lg:mt-0 text-white font-semibold hover:text-white mr-4 text-lg bg-green-300 px-2 py-1 rounded-full uppercase flex-shrink-0'>Shop</Link>
                   </div>
